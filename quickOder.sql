SET NAMES 'utf8';
DROP DATABASE IF EXISTS quickOder;
CREATE DATABASE quickOder CHARSET=UTF8;
USE quickOder;

CREATE TABLE doris_dish(
...
INSERT INTO doris_dish(did,img_sm,img_lg,name,price,material,detail) VALUES
(   null,
    'p0281.jpg',
    'p0281-l.jpg',
    '【酸甜开胃虾】',
...
INSERT INTO doris_order(oid, phone,user_name,sex,order_time,addr,did) VALUES
(NULL,'13501234567','客户1',1,1445154859209,'北京市朝阳区',3),
(NULL,'13207654321','客户2',1,1445254997612,'北京市海淀区',2),
(NULL,'13899999999','客户3',1,1445354959209,'北京市东城区',5),
(NULL,'13683675299','客户4',2,1445354889209,'北京市西城区',4);

##SELECT * FROM doris_order;